    ...
    <div class="row g-0">
        ...
        <div class="col-md-8">
            <div class="card-body">
                ...
                <h4><span class="text-secondary">Face ID:</span>${phone.mainFeatures.sensors[0]}</h4>
                <h4><span class="text-secondary">accelerometer:</span>${phone.mainFeatures.sensors[1]}</h4>
                <h4><span class="text-secondary">gyro:</span>${phone.mainFeatures.sensors[2]}</h4>
                <h4><span class="text-secondary">proximity:</span>${phone.mainFeatures.sensors[3]}</h4>
                <h4><span class="text-secondary">proximity:</span>${phone.mainFeatures.sensors[4]}</h4>
                <h4><span class="text-secondary">barometer:</span>${phone.mainFeatures.sensors[5]}</h4>
